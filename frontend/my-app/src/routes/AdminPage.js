  ...
  return (
    <div className="App">
      <button
        ...
        type="button"
        className="fixed top-2 left-3 z-40 inline-flex items-center p-4 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
      >
          ...
          <ul className="space-y-3 font-medium">
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-4">Users</span>
              </Link>
            </li>
            <li>
              <Link
      ...
      {sidebarOpen && (
        <button
          ...
          type="button"
          style={{ top: "-0.45%" }}
          className="fixed top-2 right-2 z-50 inline-flex items-center p-4 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
        >
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M10 8.586l-3.293-3.293-1.414 1.414L8.586 10l-3.293 3.293 1.414 1.414L10 11.414l3.293 3.293 1.414-1.414L11.414 10l3.293-3.293-1.414-1.414L10 8.586z"
            />
          </svg>
        </button>
      )}
